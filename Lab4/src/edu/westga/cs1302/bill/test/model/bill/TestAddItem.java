...
class TestAddItem {
  ...
  @Test
   void testAddToEmptyBill() {
    ...
    assertEquals("orange", bill.getItems().get(0).getName(), "checks name of the first bill item");
    assertEquals(1, bill.getItems().get(0).getAmount(), "checks amount of the first bill item");
  }
  ...
  void testAddToNonEmptyBill() {
    ...
    assertEquals("banana", bill.getItems().get(1).getName(), "checks name of the second bill item");
